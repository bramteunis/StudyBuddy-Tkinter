...
def main():
    ...
    def homepage():
        ...
        DropButton(LG, text='Start',        padx=2, pady=0, bd=0, fg="black",font=('arial', 10), width= 12, height=2,bg=safecolor,command=main).grid(row=0,column=1)
    ...
    def knorth():
        ...
        def week2():
            ...
            test = Canvas(LG,bg=safecolor,bd=0,height=285,width=1);test.place(x=98,y=135);test.place(x=102,y=135);test.place(x=308,y=135);test.place(x=312,y=135);test.place(x=518,y=135);test.place(x=522,y=135);test.place(x=728,y=135);test.place(x=732,y=135);test.place(x=938,y=135);test.place(x=942,y=135);test.place(x=1148,y=135);test.place(x=1152,y=135)
            test2 = Canvas(LG,bg=safecolor2,bd=0,height=164,width=1);test2.place(x=98,y=526);test2.place(x=102,y=526);test2.place(x=308,y=526);test2.place(x=312,y=526);test2.place(x=518,y=526);test2.place(x=522,y=526);test2.place(x=728,y=526);test2.place(x=732,y=526);test2.place(x=938,y=526);test2.place(x=942,y=526);test2.place(x=1148,y=526);test2.place(x=1152,y=526)
            test3 = Canvas(LG,bg=safecolor,bd=0,height=1,width=1050)
            Canvas(LG,bg=safecolor,bd=0,height=1,width=1050).place(x=100,y=139)
            Canvas(LG,bg=safecolor,bd=0,height=1,width=1050).place(x=100,y=416)
            Canvas(LG,bg=safecolor,bd=0,height=1,width=1050).place(x=100,y=420)
            test4 = Canvas(LG,bg=safecolor2,bd=0,height=1,width=1050); test4.place(x=100,y=526); test4.place(x=100,y=530); test4.place(x=100,y=686); test4.place(x=100,y=690)
